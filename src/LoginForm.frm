...
Private Sub OKButton_Click()
    ...
    End If
    bLoginOK = True
    If tbUserID.Text <> temp_tbUserID Then
        Call FormCommon.dropDBObjectsCache
      '  tbRole = ""
      ' we don't know these values. They will be set later
        Utils.CustomRange(sgRangeRole) = "" ' this is only needed because of a bug
        Utils.CustomRange(sgRangeWarehouse) = ""
    End If
    Call setCancelVariables
    Me.Hide
